...
<div id="container">
    ...
    <div id="body">
        ...
        <p>
            Berikut daftar web service yang tersedia di bphtb
        </p>
        ...
        <ol>
            <!--<li><a href="<?php echo site_url('api/bphtb/ketetapan/awal/20160101/akhir/20160131'); ?>">Ketetapan</a> - defaulti JSON<br>
           ...
           <p> [{"kode":"1","uraian":"HOTEL","pokok":"45540475314","denda":"0","bunga":"0","total":"4554047533"},
            ...
            <li><a href="<?php echo site_url('api/bphtb/masuk/awal/20160101/akhir/20160528'); ?>">Berkas Masuk</a> - defaulti JSON<br>
            <li><a href="<?php echo site_url('api/bphtb/keluar/awal/20160101/akhir/20160528'); ?>">Berkas Keluar</a> - defaulti JSON<br>
                Parameter Input :
                            <ol>
                    <li>(awal) Periode Awal : 'YYYYMMDD'</li>
                    <li>(akhir) Periode Akhir : 'YYYYMMDD'</li>
                    <li>(group) 1. Kelurahan/2. Kecamatan</li>
